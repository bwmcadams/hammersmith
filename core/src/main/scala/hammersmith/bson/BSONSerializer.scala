...
abstract class BSONSerializer extends BasicBSONEncoder with Logging {
  ...
  protected val _putHandle: PartialFunction[AnyRef, Function1[String, Unit]] = {
    ...
    case bin: org.bson.types.Binary ⇒ {
