...
import hammersmith.MongoConnection
...
class NettyConnectionContext protected[hammersmith](private val channel: Channel) extends ConnectionContext with Logging {
...
protected[hammersmith] class NettyConnectionHandler(val bootstrap: ClientBootstrap) extends SimpleChannelHandler with MongoConnectionHandler {
